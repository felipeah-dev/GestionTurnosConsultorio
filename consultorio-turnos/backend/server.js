...
import { actualizarEstadoTurno, crearTurno, obtenerTurnosPaciente, obtenerDetalleTurno } from "./controllers/turnos.controller.js";
...
app.get('/api/turnos/:id', verifyToken, authorizeRoles(1, 2), obtenerDetalleTurno);
